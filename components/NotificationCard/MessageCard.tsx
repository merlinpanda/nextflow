...
import { IconApps, IconArrowRight, IconBrandAppstore, IconBrandOpenai, IconBrandTiktoFilled, IconBrandWechat } from "@tabler/icons-react";
...
export default function MessageCard({ code, type, app, time, intro }: MessageCardProps) {
    ...
    <>
      <Box>
        <Stack spacing={6}>
          ...
          <Text lineClamp={3} size={12} >{intro}</Text>
        </Stack>
      </Box>
    </>
  );
